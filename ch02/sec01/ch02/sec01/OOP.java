...
*
* package-info.java - предоставление информации о пакете, к которому относится.package ch02.sec01;
import java.time.LocalDate;
import java.util.ArrayList;
import java.util.Random;
...
* @inheritDoc - использование документации родительского класса или интерфейса.
*
* package-info.java - предоставление информации о пакете, к которому относится.
* index.html - основная страница документации.
* package-summary.html - страница, описывающая краткую информацию о пакете.
* package-tree.html - страница, содержащая древовидное представление пакетов и классов.
* package-use.html - страница, отображающая классы и интерфейсы, которые используются в данном пакете.
* overview.html - страница с обзором пакета или библиотеки.
*/
