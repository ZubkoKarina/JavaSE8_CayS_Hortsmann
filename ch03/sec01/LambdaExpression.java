...
* Локальный класс не определяеться ни как private, ни как protected, ни как public, потому что он вообще не выходит за пределы метода
* Анонимный класс - это локальный класс без имени. new Интерфейс() { ... }
*/